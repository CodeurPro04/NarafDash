...
import { Building, Trash2, Search, Eye, MapPin, Banknote, User, Calendar, Image, Plus, Upload, Save } from 'lucide-react';
              ...
              <form onSubmit={handleCreateProperty} className="space-y-6">
                <div className="surface-panel p-6 space-y-6">
                  <div>
                    ...
                    <p className="text-sm text-[rgba(15,42,46,0.6)] mt-2">Creez directement une propriete depuis l'espace administrateur.</p>
                  </div>
                    ...
                    {filteredProperties.map((property) => (
                      <div key={property.uuid || property.id} className="surface-panel p-5">
                        ...
                        <div className="flex flex-wrap gap-2 mt-4">
                          ...
                          <button onClick={() => handleForceDelete(property.uuid)} className="btn-ghost flex-1"><Trash2 className="h-4 w-4" />Supprimer</button>
                        </div>
                      </div>
                    ))}
                  </div>
